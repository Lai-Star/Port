        ...
        return (
            <>
                ...
                <div className='my-4 w-28 md:w-full h-8 px-2 md:px-2.5 flex justify-center items-center'>
                    <a class="flex justify-center items-center gap-1.5 w-4/5 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full" href="https://github.com/Lai-Star/Hotel-Room-Booking-System" target="_blank">
    ...
    return (
        <>
            ...
            <div className="mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>こんにちは！ <span className="font-bold">赖仓钰(ライ・カンユ)</span> ,</div>
                <div className="font-normal ml-1"><span className="text-orange-500 font-bold">ソフトウェアエンジニア!</span></div>
            </div>
            <ul className="mt-4 leading-tight tracking-tight text-sm md:text-base w-full md:w-5/6 emoji-list">
                ...
                私は台湾の嘉義市出身で、2012年9月に台湾の国立嘉義大学を卒業しました。その後、2012年9月から4年間、日本のY'S株式会社で正社員として勤務しました。
                Y'S株式会社での経験において、CERCA在庫管理販売システムの要件定義から詳細設計、実装、テスト、導入など、多岐にわたる業務を担当しました。
                さらに、勤怠管理システムや生産管理システムなどの業務系アプリの開発にも貢献しました。
                その後、2016年9月に台湾のJINDA株式会社に転職し、PMとして活躍しました。
                この期間にも、日本の企業からの業務委託を受けて、ウェブシステム案件やスマートフォンアプリ、Windowsアプリの開発に取り組みました。
                2021年1月からはフリーランスとして活動し、クラウドワークスやランサーズを通じて、日本の個人や企業クライアントからウェブシステム開発案件に対応しました。
                また、FreelanceやUpworkなどの国際的なプラットフォームを活用して、アメリカやヨーロッパのクライアントからもブロックチェーン関連の開発案件に参加しました。<br />
                    <br />- <span className="text-pink-700 font-bold">使用言語:</span> Javascript, Typescript, PHP, Python, Ruby, Go, C, Solidity
                    <br />- <span className="text-pink-700 font-bold">フロントエンド:</span> HTML, CSS, React, Vue, Next, Nuxt, Angular, Tailwind CSS, MUI, Bootstrap, Antd
                    <br />- <span className="text-pink-700 font-bold">バックエンド:</span> Laravel, Symfony, CodeIgniter, Wordpress, Node.js(express), Nest.js, Django, Ruby on Rails,
                    <br />- <span className="text-pink-700 font-bold">スマポアプリケーション:</span> React-Native, Android, Swfit
                    <br />- <span className="text-pink-700 font-bold">DevOps:</span> AWS EC2, S3, Lambda, RDS, Git, CI/CD, Docker, Azure, Firebase, Heroku
                    <br />- <span className="text-pink-700 font-bold">データベース:</span> MySQL, PostgreSQL, Oracle, MongoDB, Redis, Firebase Runtime Database, AWS DynamoDB
                    <br />- <span className="text-pink-700 font-bold">Restful API:</span> OpenAI API, Midjourney API, FastAPI, Rasa, ChatGPT, テキスト音声変換, 音声テキスト変換
                    <br />- <span className="text-pink-700 font-bold">その他:</span> Docker, Laradocker, Notion, Backlog, Sentry.io, Datadog, Miro, DBDocs, Asana, DBDiagram
                    <br />私はあなたの<span className="text-pink-600 font-bold">野心的なプロジェクトを支援する準備ができています。</span> ありがとうございます。
                    <br />(メールはこちらまで <a className='text-pink-600 font-bold' href='mailto:tsangyu.lai0920@gmail.com'> @tsangyu.lai0920@gmail.com </a> )
                </li>
                <li className="mt-3 list-building text-xl font-sans"> 私は、素晴らしいサービスが必要な<span className="text-pink-600 font-bold">素敵なウェブサイトや製品を作るのが大好きです。</span></li>
                <li className="mt-3 list-time text-xl font-sans"> 自由な時間があるときは、本を読んだり、ゲームをしたり、<a className="text-pink-600 font-bold" href="https://medium.com/@nicole-blog" target="_blank">ブログを書いたりするのが好きです。</a></li>
            </ul>

            <br />
            <div className="mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>This is <span className="font-bold">Tsangyu Lai</span> ,</div>
                <div className="font-normal ml-1">I'm a <span className="text-orange-500 font-bold">Software Engineer!</span></div>
            </div>
            <ul className="mt-4 leading-tight tracking-tight text-sm md:text-base w-full md:w-5/6 emoji-list">
                <li className="list-pc text-xl font-sans">
                I am from Chiayi City, Taiwan, and I graduated from National Chiayi University in September 2012. After that, I worked as a full-time employee at Y'S Co., Ltd. in Japan for four years, starting in September 2012.

                During my time at Y'S Co., Ltd., I was involved in a wide range of tasks, including requirement definition, detailed design, implementation, testing, and deployment for the CERCA inventory management and sales system. Additionally, I contributed to the development of business applications such as attendance management systems and production management systems.

                In September 2016, I transitioned to JINDA Co., Ltd. in Taiwan, where I worked as a Project Manager (PM). During this period, I also received contracts from Japanese companies to work on web system projects, smartphone applications, and Windows applications.

                Since January 2021, I have been working as a freelancer, handling web system development projects for individual and corporate clients in Japan through platforms like CrowdWorks and Lancers. I have also leveraged international platforms like Freelance and Upwork to participate in blockchain-related development projects for clients in the United States and Europe. <br/>
                    <br />- <span className="text-pink-700 font-bold">Languages:</span> Javascript, Typescript, PHP, Python, Ruby, Go, C, Solidity
                    <br />- <span className="text-pink-700 font-bold">Front-end:</span> HTML, CSS, React, Vue, Next, Nuxt, Angular, Tailwind CSS, MUI, Bootstrap, Antd
                    <br />- <span className="text-pink-700 font-bold">Back-end:</span> Laravel, Symfony, CodeIgniter, Wordpress, Node.js(express), Nest.js, Django, Ruby on Rails,
                    <br />- <span className="text-pink-700 font-bold">Mobile-App:</span> React-Native, Android, Swfit
                    <br />- <span className="text-pink-700 font-bold">DevOps:</span> AWS EC2, S3, Lambda, RDS, Git, CI/CD, Docker, Azure, Firebase, Heroku
                    <br />- <span className="text-pink-700 font-bold">DB:</span> MySQL, PostgreSQL, Oracle, MongoDB, Redis, Firebase Runtime Database, AWS DynamoDB
                    <br />- <span className="text-pink-700 font-bold">Restful API:</span> OpenAI API, Midjourney API, FastAPI, Rasa, ChatGPT
                    <br />- <span className="text-pink-700 font-bold">other:</span> Docker, Laradocker, Notion, Backlog, Sentry.io, Datadog, Miro, DBDocs, Asana, DBDiagram
                    <br />(please contact to this address <a className='text-pink-600 font-bold' href='mailto:tsangyu.lai0920@gmail.com'> @tsangyu.lai0920@gmail.com </a> )
                </li>
